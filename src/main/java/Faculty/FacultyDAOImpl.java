...
public class FacultyDAOImpl implements FacultyDAO {
    ...
    public DefaultTableModel fetchAll() {
        ...
        Vector<String> columns = new Vector<>(List.of("ID", "College", "Position", "First Name", "Middle Name", "Last Name", "Sex", "Birthdate", "Contact Number", "Email", "Barangay", "Municipality"));
